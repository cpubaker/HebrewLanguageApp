...
- The current vocabulary deck is intentionally mixed:
  ...
  - some grammar-facing entries whose gloss is explanatory rather than dictionary-short.
...
- Keep Hebrew spelling, Ukrainian gloss style, English fallback gloss style, and transliteration style consistent with neighboring entries unless the task is a deliberate normalization pass.
